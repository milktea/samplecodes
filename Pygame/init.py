...
#function to place the helicopter
def helicopter(x,y,image):
   surface.blit(img, (x,y))

#define helicopter image
...
def msgSurface(text):
    ...
    #half of the width; half of the height
    ...
    while not game_over:
	    ...
	    if event.type == pygame.QUIT:
      	    ...
      	    if event.type == pygame.KEYDOWN:
    		    ...
    		    #negative movement is an upward movement		
    	   	    y_move = -5
